...
--if vehicle.aseIsTurnMode7 then
--	vehicle.aseDirectionBeforeTurn.cx,_,vehicle.aseDirectionBeforeTurn.cz = localToWorld( vehicle.aseOtherI, vehicle.aseOffset, 0, vehicle.aseBack + turnX + vehicle.aseWidth )
--else
